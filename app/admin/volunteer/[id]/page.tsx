  ...
  const handleLogout = async () => {
    ...
    const Sidebar = () => (
      <>
        ...
        {/* Sidebar */}
        <div
          className={`fixed left-0 top-0 h-screen w-full max-w-xs sm:max-w-sm md:w-[375px] bg-[#E1E69D] z-40 transition-transform transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} overflow-y-auto px-4 py-6`}
          style={{
            display: "flex",
            ...
            <>
              ...
              <div className="max-w-2xl md:max-w-3xl lg:max-w-5xl mx-auto px-2 sm:px-4 md:px-6 pb-8 w-full">
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden w-full">
                  <div className="relative min-h-[112px] flex flex-col sm:flex-row items-center px-2 sm:px-6 gap-4" style={{ backgroundColor: '#C2C876' }}>
                    <div className="flex flex-row items-center gap-4 mt-4 mb-1 sm:mb-2 justify-start w-full">
                      <div className="h-14 w-14 sm:h-16 sm:w-16 rounded-full flex items-center justify-center text-base sm:text-xl font-bold" style={{ backgroundColor: '#3C3333', color: 'white', fontFamily: 'Genty Sans, sans-serif' }}>
                  ...
                  <div className="p-2 sm:p-4 md:p-6">
                    {volunteer.call_details && (
                      <p className="leading-relaxed mb-6 whitespace-pre-line text-sm sm:text-base" style={{ color: '#3C3333', fontFamily: '"Genty Sans", sans-serif' }}>{volunteer.call_details}</p>
                    )}
                    <dl className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 text-xs sm:text-sm w-full">
                      <div>
                      ...
                      <div>
                        ...
                        <dd style={{ color: '#3C3333', fontFamily: '"Genty Sans", sans-serif' }}>{typeof volunteer.capacity === 'number' ? volunteer.capacity : 'Unlimited'}</dd>
                      </div>
                      <div>
                    ...
                    <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-2 sm:gap-3 w-full">
                      ...
                      {/* Show Uncomplete button if status is completed */}
                      {volunteer.call_status?.toLowerCase() === 'completed' && (
                        <form action={uncompleteAction}>
                          <input type="hidden" name="id" value={volunteer.call_id} />
                          <button 
                            type="submit" 
                            className="px-4 py-2 rounded-md text-sm font-semibold hover:opacity-90 transition-opacity"
                            style={{ backgroundColor: '#C2C876', color: '#3C3333', fontFamily: '"Genty Sans", sans-serif' }}
                          >
                            Uncomplete Request
                          </button>
                        </form>
