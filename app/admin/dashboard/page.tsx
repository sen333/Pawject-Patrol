          ...
          <section className="w-full max-w-[1400px] mx-auto px-6 -mt-23 md:-mt-12 lg:-mt-24 pb-12">
            <div className="flex flex-col gap-5 lg:gap-6 self-stretch rounded-2xl bg-[#E6E6E6] py-5 px-5 lg:py-8 lg:px-8 shadow-[0_4px_6px_0_rgba(0,0,0,0.09)]">
              <div className="flex flex-col lg:flex-row gap-5 lg:gap-6">
                ...
                <button className="flex w-full lg:flex-1 min-h-[86px] lg:min-h-[110px] rounded-xl overflow-hidden shadow-md transition-transform hover:scale-105 active:scale-95 text-left border-2 border-[#C575AD] bg-[#fcfcfc]">
                ...
                <button className="flex w-full lg:flex-1 min-h-[86px] lg:min-h-[110px] rounded-xl overflow-hidden shadow-md transition-transform hover:scale-105 active:scale-95 text-left border-2 border-[#5E9BBA] bg-[#fcfcfc]">
                  <div className="flex-1 px-4 py-5">
                    <h2
                      className="text-md lg:text-xl font-medium mb-0.5"
                      style={{
              ...
              <button className="flex w-full min-h-[86px] lg:min-h-[110px] rounded-xl overflow-hidden shadow-md transition-transform hover:scale-105 active:scale-95 text-left border-2 border-[#DCB57E] bg-[#fcfcfc]">
                <div className="flex-1 px-4 py-5">
                  <h2
                    className="text-md lg:text-xl font-medium mb-0.5"
                    style={{
