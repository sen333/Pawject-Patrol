						...
						<div className="p-6 md:p-8" style={{ fontFamily: '"Genty Sans", sans-serif', backgroundColor: getThemeColor(animal.animal_theme) }}>
							...
							<div className="mb-8">
								...
								<dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
									...
									<div>
										...
										<dd className="text-gray-800">{animal.animal_collar && animal.animal_collar.toLowerCase() !== 'none' ? animal.animal_collar : '—'}</dd>
									</div>
								</dl>
							</div>

							{/* Location Details Section */}
							{(animal.area || animal.date_seen || animal.landmark || animal.road) && (
								<div className="mb-8">
							...
							<div className="mt-8 flex flex-wrap gap-3">
								...
								<button
									...
									className="px-6 py-2 rounded-lg text-white text-sm font-semibold transition-all disabled:opacity-50"
									style={{
