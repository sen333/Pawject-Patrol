...
export default function ReportFormSample() {
	...
	const [sidebarOpen, setSidebarOpen] = useState(false);
			       ...
			       useEffect(() => {
				       ...
				       supabase.auth.getUser().then((result: { data: any }) => {
					       const { data } = result;
					       if (data?.user) {
			       ...
			       // Save all input fields to sessionStorage on change
			       useEffect(() => {
				       const data = {
					       recorderName,
					       animalName,
			       ...
			       }, [recorderName, animalName, animalType, gender, dateSeen, physicalDescription, otherInfo, area, landmark, road, theme, hasHealthIssues, healthDetails, hasCollar, collarDetails, lat, lng]);
		       ...
		       if (navigator.geolocation) {
			       navigator.geolocation.getCurrentPosition(
				       (pos) => {
					       ...
					       setResultMsg("Location set to your current position.");
				       },
				       () => setResultMsg("Could not get your location."),
			       );
		       } else {
			       setResultMsg("Geolocation not supported.");
		       }
	       }
	       ...
	       function handleConfirm() {
				       ...
				       setTimeout(() => {
					       ...
					       const params = new URLSearchParams({
						       ...
						       road,
						       theme,
						       healthIssues: hasHealthIssues ? healthDetails : '',
						       animalCollar: hasCollar ? collarDetails : '',
